...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recipes1.add(new Recipes("Kabsa","200 gm chopped into cubes chicken" +
        ...
        recipes1.add(new Recipes("Massob","1 c. whole milk" +
        ...
        recipes1.add(new Recipes("sambosa","3 cups rice" +
        ...
        recipes1.add(new Recipes("Shaworma","1 1/4 cups milk" +
                "1 egg" +
        ...
        recipes1.add(new Recipes("Mandy","1 tsp oil" +
                "1 tsp butter" +
